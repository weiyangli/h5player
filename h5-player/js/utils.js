...
Utils.getUUID = function () {
    ...
    s[8] = s[13] = s[18] = s[23] = '-';
    var uuid = s.join('').toString().substring(0, 32).replace(/-/g, '');
    return uuid;
};
...
Utils.SectionToChinese = function (section) {
 ...
 * 获取cookie
 *
 * @param  {String} cookie 的 key 值
 * @return {String} 对应的 cookie 信息
 */
Utils.getCookie = function (cname) {
     ...
     * @return 无返回值
     */
    Utils.chooiceAnswer = function (question, optionIndex) {
        // 1. 如果是单选题或者判断题
        ...
        if (1 == questionType || 3 == questionType) {
            ...
            // [1.2] 设置 optionIndex 对应的选项的 correct 为 true
            optionList[optionIndex].checked = true;
        } else if (2 == questionType) {
            // [2] 如果是多选题，把 optionIndex 对应的选项的 correct 置反: true 变 false，false 变 true
            optionList[optionIndex].checked = !optionList[optionIndex].checked;
        }
    }
